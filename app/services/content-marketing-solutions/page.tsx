...
import { ArrowRight, CheckCircle, Star, Clock, Edit3, Zap, ThumbsUp, ShieldCheck, ChevronDown, ChevronUp, FileText, Globe, MessageSquare, Target, Layout, BarChart3, TrendingUp, Users, DollarSign } from 'lucide-react';
...
export default function ContentCreationPage() {
  ...
  const contentCreationServices = [
    {
      title: "Blog Writing",
      description: "High-quality blog posts and articles that engage your audience, establish authority, and improve SEO rankings.",
      icon: FileText,
      features: ["SEO Blog Posts", "Industry Articles", "Thought Leadership", "Guest Posts"],
      deliverables: ["SEO-optimized articles", "Engaging content", "Research-backed posts", "Publishing schedule"]
    },
    {
      title: "Website Content",
      description: "Professional website copy including landing pages, service descriptions, and about pages that convert visitors.",
      icon: Globe,
      features: ["Landing Pages", "Service Pages", "About Pages", "Product Descriptions"],
      deliverables: ["Conversion-focused copy", "Brand-aligned content", "SEO optimization", "User experience focused"]
    },
    {
      title: "Social Media Content",
      description: "Engaging social media posts, captions, and content calendars designed to grow your following and engagement.",
      icon: MessageSquare,
      features: ["Post Creation", "Content Calendar", "Hashtag Strategy", "Visual Content"],
      deliverables: ["Daily post content", "Engagement strategy", "Platform optimization", "Growth tactics"]
    },
    {
      title: "Marketing Materials",
      description: "Compelling marketing content including email campaigns, newsletters, brochures, and promotional materials.",
      icon: Target,
      features: ["Email Campaigns", "Newsletters", "Brochures", "Sales Materials"],
      deliverables: ["Campaign content", "Brand materials", "Sales copy", "Marketing assets"]
    }
  ]
  ...
  const pricingPlans = [
    ...
    },
    {
      name: "Enterprise",
      price: "$1,899/month",
      description: "For content-driven businesses",
      features: [
  ...
  const processSteps = [
    {
      ...
      description: "Understand your brand, audience, and goals to create a comprehensive content strategy that drives results.",
      duration: "Same day",
      icon: MessageSquare
    },
    {
      ...
      description: "Develop content calendars, topic research, and editorial guidelines aligned with your marketing objectives.",
      duration: "1-2 days",
      icon: Layout
    },
    {
      ...
      description: "Produce high-quality, engaging content optimized for your target audience and platform requirements.",
      duration: "3-5 days",
      icon: Edit3
    },
    {
      ...
      description: "Review performance metrics and continuously optimize content strategy for maximum engagement and results.",
      duration: "Ongoing",
      icon: BarChart3
    }
  ]
  ...
  const benefits = [
    {
      ...
      description: "High-quality content that resonates with your audience and drives meaningful interactions",
    ...
    },
    {
      ...
      description: "Strategic content that attracts new followers and builds a loyal community around your brand",
      metric: "250% Follower Growth",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: DollarSign,
      title: "Lead Generation",
      description: "Content optimized for conversions that turns readers into qualified leads and customers",
    ...
    },
    {
      ...
      description: "Establish thought leadership and build trust through consistent, valuable content",
      metric: "95% Brand Recognition",
  ...
  const testimonials = [
    {
      text: "TasksACE's content creation transformed our digital presence completely. Our blog traffic increased by 400% and we're now seen as industry leaders. The quality is exceptional!",
    ...
    {
      text: "The social media content they create consistently drives engagement. Our follower count grew by 300% and we're getting leads directly from social media posts.",
      author: "Mike Chen",
      company: "E-commerce Brand",
      role: "Social Media Manager",
      rating: 5,
      savings: "300% follower growth",
      timeframe: "4 months"
    },
    {
      text: "Professional package has been a game-changer for our content marketing. The blog posts rank well in search and our email campaigns have much higher open rates.",
      author: "Jennifer Davis",
      company: "Consulting Firm",
      role: "Business Owner",
      rating: 5,
      savings: "Higher rankings",
      timeframe: "8 months"
    },
    {
      text: "The landing pages they created converted 60% better than our previous ones. Their understanding of user psychology and conversion optimization is impressive.",
      author: "David Rodriguez",
      company: "SaaS Company",
      role: "Growth Manager",
      rating: 5,
      savings: "60% better conversion",
      timeframe: "3 months"
    },
    {
      text: "Enterprise package provides everything we need for content marketing. The dedicated team feels like an extension of our company and delivers consistently.",
      author: "Lisa Thompson",
      company: "Enterprise Corp",
      role: "CMO",
      rating: 5,
      savings: "Complete solution",
      timeframe: "12 months"
    },
    {
      text: "The content strategy and execution have positioned us as thought leaders. We're now getting speaking opportunities and media coverage thanks to our content.",
      author: "Robert Kim",
      company: "Professional Services",
      role: "Managing Partner",
      rating: 5,
      savings: "Industry leadership",
      timeframe: "10 months"
    }
  ]
  ...
  const faqs = [
    {
      ...
      answer: "We create all types of content including blog posts, website copy, social media content, email campaigns, landing pages, product descriptions, marketing materials, and more. All content is customized to your brand and audience."
    },
    {
      question: "How do you ensure content quality and brand consistency?",
      answer: "We develop detailed brand guidelines and style guides for each client. Our team includes experienced writers and editors who ensure all content meets high quality standards and maintains consistent brand voice."
    },
    {
      question: "Can you help with content strategy and planning?",
      answer: "Absolutely! We develop comprehensive content strategies including editorial calendars, topic research, SEO planning, and distribution strategies aligned with your marketing goals and business objectives."
    },
    {
      question: "Do you provide SEO optimization for content?",
      answer: "Yes! All our content includes SEO optimization with keyword research, proper keyword placement, meta descriptions, and content structure that helps improve search engine rankings and organic traffic."
    },
    {
      question: "What's the typical turnaround time for content?",
      answer: "Blog posts typically take 3-5 days, social media content 1-2 days, and larger projects like landing pages 5-7 days. Enterprise clients get priority scheduling and faster turnaround times."
    }
  ]

  const stats = [
    { label: "Content Pieces Created", value: "25,000+", icon: FileText, color: "from-primary-500 to-orange-500" },
    { label: "Brands Served", value: "600+", icon: Users, color: "from-blue-500 to-cyan-500" },
    { label: "Avg Engagement Boost", value: "+280%", icon: TrendingUp, color: "from-green-500 to-emerald-500" },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center bg-primary-500/10 rounded-full px-4 py-2 mb-6 border border-primary-500/20">
                <Edit3 className="w-4 h-4 text-primary-400 mr-2" />
                <span className="text-primary-400 text-sm font-semibold">CONTENT CREATION EXPERTS</span>
              </div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Engage your audience with high-quality content that drives results. From blog posts to social media, we create content that converts and builds your brand.
              </p>
              ...
              <div className="flex items-center gap-6 text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">25K+ Content Pieces</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-yellow-500" />
                  <span className="text-sm">+280% Engagement</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">Complete Content Creation</h3>
                  <p className="text-gray-300">All content needs covered</p>
                </div>
                
                <div className="space-y-4 mb-8">
                  {['Blog Writing', 'Website Content', 'Social Media', 'Marketing Materials', 'Content Strategy'].map((item, index) => (
                ...
                <div className="bg-white/5 rounded-lg p-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white mb-1">Starting at $299/month</div>
                    <div className="text-primary-400 text-sm">4 blog posts + social media</div>
                  </div>
                </div>
        ...
        <div className="max-w-[1344px] mx-auto container-padding">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive content creation services designed to engage your audience and drive business growth.
            </p>
          </div>
        ...
        <div className="max-w-[1344px] mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Measurable improvements to your content marketing performance and business growth.
            </p>
          </div>
      ...
      <section id="pricing" className="section-padding bg-white">
        <div className="max-w-[1344px] mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Transparent pricing with no hidden fees. Choose the perfect plan for your content creation needs.
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-[1344px] mx-auto container-padding relative">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From strategy to execution, we follow a proven process to create content that engages your audience and drives results.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-primary-50 to-orange-50 rounded-3xl p-8 border border-primary-200">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Start building your brand with high-quality content that resonates with your audience and drives business growth.
              </p>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-[1344px] mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Real results from businesses that have grown with our content creation services.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            <div className="inline-flex items-center space-x-2 bg-primary-50 rounded-full px-4 py-2 mb-6 border border-primary-200">
              ...
              <span className="text-sm font-semibold text-primary-700">Ready to Create?</span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Join hundreds of businesses that have grown their audience with TasksACE's professional content creation services.
            </p>
