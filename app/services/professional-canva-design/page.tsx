...
import { ArrowRight, CheckCircle, Star, Clock, Palette, Zap, ThumbsUp, ShieldCheck, ChevronDown, ChevronUp, FileText, Target, Layout, Image, MessageSquare, BarChart3, DollarSign, TrendingUp, Users } from 'lucide-react';
import Link from 'next/link'

export default function GraphicDesignCanvaPage() {
  ...
  const canvaServices = [
    {
      title: "Flyer Design",
      description: "Eye-catching flyers for events, promotions, and business announcements using professional Canva templates.",
      icon: FileText,
      features: ["Event Flyers", "Promotional Materials", "Business Announcements", "Custom Layouts"],
      deliverables: ["High-resolution flyers", "Print-ready files", "Web versions", "Editable templates"]
    },
    {
      title: "Logo Creation",
      description: "Professional logo design that represents your brand identity perfectly with multiple concept variations.",
      icon: Target,
      features: ["Brand Identity", "Multiple Concepts", "Vector Files", "Color Variations"],
      deliverables: ["Logo files (PNG, JPG, SVG)", "Brand guidelines", "Color palettes", "Usage guidelines"]
    },
    {
      title: "Banner Design",
      description: "Stunning banners for websites, social media, and advertising campaigns optimized for all platforms.",
      icon: Layout,
      features: ["Web Banners", "Social Media", "Print Banners", "Ad Campaigns"],
      deliverables: ["Multi-format banners", "Platform-specific sizes", "Animated versions", "Brand assets"]
    },
    {
      title: "Social Media Graphics",
      description: "Engaging graphics optimized for all social media platforms to boost your online presence.",
      icon: Image,
      features: ["Instagram Posts", "Facebook Graphics", "LinkedIn Content", "Story Templates"],
      deliverables: ["Platform-optimized graphics", "Content templates", "Brand kit", "Posting schedule"]
    }
  ]
  ...
  const pricingPlans = [
    {
      name: "Starter",
      price: "$15/design",
      description: "Perfect for basic graphic design needs",
      features: [
        "1 Design Concept",
        "2 Revisions",
        "24-48 Hour Delivery",
    ...
    },
    {
      name: "Professional",
      price: "$35/design",
      description: "Most popular for businesses and brands",
      features: [
        "3 Design Concepts",
        "Unlimited Revisions",
        "12-24 Hour Delivery",
    ...
    },
    {
      name: "Enterprise",
      price: "$199/month",
      description: "For ongoing design needs and brand management",
      features: [
  ...
  const processSteps = [
    {
      step: "01",
      title: "Design Brief",
      description: "Share your requirements, brand guidelines, and design preferences with our creative team.",
      duration: "Same day",
      icon: MessageSquare
    },
    {
      ...
      description: "Our designers create initial concepts using Canva's professional tools and premium templates.",
      duration: "1-2 days",
      icon: Target
    },
    {
      step: "03",
      title: "Review & Refine",
      description: "Review the designs and request any changes or refinements needed for perfection.",
      duration: "24 hours",
      icon: Zap
    },
    {
      ...
      description: "Receive your completed designs in multiple formats ready for immediate use across all platforms.",
      duration: "Same day",
      icon: BarChart3
    }
  ]
  ...
  const benefits = [
    {
      ...
      description: "Save up to 70% compared to hiring a professional designer or design agency",
    ...
    },
    {
      icon: Clock,
      title: "Fast Delivery",
      description: "Quick turnaround times with most designs completed within 24-48 hours",
      metric: "24-48 Hours",
    ...
    },
    {
      ...
      description: "High-quality designs using Canva Pro tools and premium templates for stunning results",
    ...
    },
    {
      ...
      description: "Consistent visual identity across all your marketing materials and brand assets",
  ...
  const testimonials = [
    {
      text: "TasksACE's Canva designs transformed our marketing materials completely. Our social media engagement increased by 300% and our brand looks incredibly professional across all platforms!",
      author: "Sarah Johnson",
      company: "Creative Studio Agency",
      role: "Marketing Director",
      rating: 5,
      savings: "300% more engagement",
      timeframe: "3 months"
    },
    {
      text: "The logo design service exceeded our expectations. Multiple concepts, perfect execution, and all file formats delivered. Our new brand identity is exactly what we envisioned.",
      author: "Mike Chen",
      company: "Tech Innovations Inc.",
      role: "CEO",
      rating: 5,
      savings: "Perfect brand identity",
      timeframe: "2 weeks"
    },
    {
      text: "Banner designs for our campaigns are always stunning and convert incredibly well. Professional quality at a fraction of traditional design agency costs.",
      author: "Lisa Rodriguez",
      company: "E-commerce Solutions",
      role: "Growth Manager",
      rating: 5,
      savings: "5x better conversion",
      timeframe: "6 months"
    },
    {
      text: "Event flyers designed by TasksACE helped us sell out our conferences. The designs are eye-catching, professional, and perfectly capture our event themes.",
      author: "David Thompson",
      company: "Event Management Pro",
      role: "Event Coordinator",
      rating: 5,
      savings: "Sold out events",
      timeframe: "4 months"
    },
    {
      text: "The enterprise package with dedicated designer has been game-changing. Brand consistency across all materials and same-day delivery keeps our marketing on track.",
      author: "Emma Wilson",
      company: "Digital Marketing Hub",
      role: "Creative Director",
      rating: 5,
      savings: "Same-day delivery",
      timeframe: "8 months"
    },
    {
      text: "Social media graphics package boosted our online presence significantly. Templates are reusable and our posts now look professional and engaging every time.",
      author: "James Park",
      company: "Content Creation Studios",
      role: "Social Media Manager",
      rating: 5,
      savings: "Professional presence",
      timeframe: "5 months"
    }
  ]
  ...
  const faqs = [
    {
      question: "What types of designs can you create with Canva?",
      answer: "We can create flyers, logos, banners, social media graphics, business cards, presentations, brochures, infographics, and any other visual content using Canva's professional tools and premium templates."
    },
    {
      question: "How long does it take to complete a design project?",
      answer: "Most single designs are completed within 24-48 hours. Complex projects or multiple design concepts may take 2-3 days. Enterprise clients receive same-day delivery for urgent requests."
    },
    {
      question: "Can you work with my existing brand guidelines?",
      answer: "Absolutely! We can incorporate your existing brand colors, fonts, logos, and style guidelines to ensure perfect consistency across all your marketing materials and brand assets."
    },
    {
      question: "What file formats will I receive?",
      answer: "You'll receive your designs in multiple formats including JPG, PNG, PDF for print, and the editable Canva file. Professional and Enterprise packages include additional formats like SVG for logos."
    },
    {
      question: "Do you offer unlimited revisions?",
      answer: "Professional and Enterprise packages include unlimited revisions until you're completely satisfied. Starter package includes 2 revisions, with additional revisions available for a small fee."
    }
  ]

  const stats = [
    { label: "Designs Created", value: "5,000+", icon: Image, color: "from-primary-500 to-orange-500" },
    { label: "Happy Clients", value: "500+", icon: Users, color: "from-blue-500 to-cyan-500" },
    { label: "Average Delivery", value: "<24hrs", icon: Clock, color: "from-green-500 to-emerald-500" },
    { label: "Client Rating", value: "4.9/5", icon: Star, color: "from-purple-500 to-violet-500" }
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center bg-primary-500/10 rounded-full px-4 py-2 mb-6 border border-primary-500/20">
                ...
                <span className="text-primary-400 text-sm font-semibold">CANVA DESIGN EXPERTS</span>
              </div>
              
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight">
                Professional Graphic Design with Canva
              </h1>
              
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Stunning, professional-quality graphics designed with Canva's premium tools. From logos to social media graphics, we create designs that make your brand stand out.
              </p>
              ...
              <div className="flex items-center gap-6 text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">5,000+ Designs Created</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">Complete Design Solution</h3>
                  <p className="text-gray-300">All graphic design needs handled</p>
                </div>
                
                <div className="space-y-4 mb-8">
                  {['Flyer Design', 'Logo Creation', 'Banner Design', 'Social Media Graphics', 'Brand Materials'].map((item, index) => (
                ...
                <div className="bg-white/5 rounded-lg p-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white mb-1">Starting at $15/design</div>
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive Canva design services to create stunning visuals that elevate your brand and marketing efforts.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {canvaServices.map((service, index) => {
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Measurable improvements to your brand presence and marketing effectiveness.
            </p>
          </div>
      ...
      <section id="pricing" className="section-padding bg-white">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Transparent pricing with no hidden fees. Choose the perfect plan for your design needs.
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto container-padding relative">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From concept to completion, we follow a systematic approach to deliver exceptional Canva designs that exceed your expectations.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-primary-50 to-orange-50 rounded-3xl p-8 border border-primary-200">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Our design team can start creating stunning Canva graphics for your brand within hours. Let's discuss your design needs and bring your vision to life.
              </p>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Real results from businesses that have elevated their brand with our professional Canva design services.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Ready to Elevate Your Brand with Professional Canva Designs?
            </h2>
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Join hundreds of businesses that have transformed their visual presence with TasksACE's professional Canva design services.
            </p>
