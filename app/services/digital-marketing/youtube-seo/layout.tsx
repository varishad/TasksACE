...
export const metadata: Metadata = {
  title: 'YouTube SEO Services | TasksACE Video Optimization',
  description: 'Professional YouTube SEO services including video optimization, keyword research, thumbnail design, and analytics. Grow your YouTube channel and increase views.',
}
