...
export const metadata: Metadata = {
  title: 'E-commerce Assistant Services | TasksACE Online Store Support',
  description: 'Dedicated e-commerce assistant services for online store management, product listings, customer support, order processing, and store optimization across all platforms.',
  keywords: 'e-commerce assistant, online store management, product listing assistant, customer support, order processing, store optimization, e-commerce virtual assistant',
}
