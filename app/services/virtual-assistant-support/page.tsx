...
import { ArrowRight, CheckCircle, Star, Clock, UserCheck, Zap, ThumbsUp, ChevronDown, ChevronUp, Target, FileText, BarChart3, Settings, MessageSquare, DollarSign, TrendingUp, ShieldCheck, Users } from 'lucide-react';
import Link from 'next/link'

export default function VirtualAssistantSupportPage() {
  ...
  const vaServices = [
    {
      ...
      description: "Complete task coordination and project management to keep your business operations running smoothly.",
      icon: Target,
      features: ["Project Planning", "Task Coordination", "Deadline Management", "Progress Tracking"],
      deliverables: ["Task schedules", "Progress reports", "Project updates", "Completion summaries"]
    },
    {
      title: "Document Preparation",
      description: "Professional document creation, formatting, and management for all your business needs.",
      icon: FileText,
      features: ["Document Creation", "Formatting & Design", "Template Development", "Version Control"],
      deliverables: ["Formatted documents", "Professional templates", "Document libraries", "Style guides"]
    },
    {
      title: "Research Activities",
      description: "Comprehensive research and analysis to support your business decisions and strategy.",
      icon: BarChart3,
      features: ["Market Research", "Competitor Analysis", "Data Compilation", "Report Creation"],
      deliverables: ["Research reports", "Market analysis", "Data presentations", "Strategic insights"]
    },
    {
      title: "Administrative Coordination",
      description: "Seamless coordination of administrative tasks and business operations support.",
      icon: Settings,
      features: ["Process Management", "Vendor Coordination", "System Administration", "Workflow Optimization"],
      deliverables: ["Process documentation", "Vendor reports", "System updates", "Workflow improvements"]
    }
  ]
  ...
  const pricingPlans = [
    {
      name: "Essential",
      price: "$10/hour",
      description: "Perfect for basic virtual assistant needs",
      features: [
        "Task Management (up to 20 tasks/month)",
    ...
    },
    {
      name: "Professional",
      price: "$14/hour",
      description: "Ideal for comprehensive VA support",
      features: [
    ...
    },
    {
      name: "Executive",
      price: "$18/hour",
      description: "For executive-level support needs",
      features: [
        "All Professional features",
        "Dedicated VA Specialist",
  ...
  const processSteps = [
    {
      ...
      description: "We understand your business requirements and virtual assistant needs.",
      duration: "1-2 days",
      icon: MessageSquare
    },
    {
      step: "02",
      title: "VA Assignment",
      description: "We match you with the perfect virtual assistant for your specific needs.",
      duration: "2-3 days",
      icon: Target
    },
    {
      ...
      description: "Your VA begins handling tasks with regular updates and quality assurance.",
      duration: "Ongoing",
      icon: Zap
    },
    {
      ...
      description: "Continuous improvement with performance tracking and workflow optimization.",
      duration: "Weekly",
      icon: BarChart3
    }
  ]
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Improve overall business efficiency with dedicated VA support",
    ...
    },
    {
      ...
      description: "Consistent, professional support with backup coverage available",
      metric: "100% Reliable",
  ...
  const testimonials = [
    {
      text: "Our virtual assistant has been a game-changer! She manages all our administrative tasks flawlessly and has freed up 30 hours per week for strategic work. Couldn't be happier!",
    ...
    {
      text: "TasksACE's VA support is exceptional. From document preparation to research, everything is handled professionally and on time. Our productivity has increased by 40%.",
      author: "Michael Chen",
      company: "Consulting Partners",
      role: "Managing Director", 
      rating: 5,
      savings: "40% productivity gain",
      timeframe: "4 months"
    },
    {
      text: "The task management support has transformed our workflow. Our VA handles everything from scheduling to document prep with incredible attention to detail. Highly recommend!",
      author: "Emily Rodriguez",
      company: "Marketing Agency Pro",
      role: "Operations Manager",
      rating: 5,
      savings: "Saved 35 hours/week",
      timeframe: "5 months"
    },
    {
      text: "Professional research and administrative support at its finest. Our virtual assistant delivers thorough reports and keeps all our projects on track. Outstanding service!",
      author: "David Wilson",
      company: "Consulting Excellence",
      role: "Business Director",
      rating: 5,
      savings: "Increased efficiency 50%",
      timeframe: "7 months"
    },
    {
      text: "The document preparation and coordination services are top-notch. Our VA has streamlined our entire administrative process. We couldn't operate without this support now.",
    ...
    {
      text: "Executive-level virtual assistant support that exceeded expectations. From strategic planning to daily coordination, the quality and professionalism are unmatched.",
      author: "Robert Davis",
      company: "Financial Advisory Group",
      role: "Senior Partner",
      rating: 5,
      savings: "ROI increased 60%",
      timeframe: "8 months"
    }
  ]
  ...
  const faqs = [
    {
      question: "How do you select and train virtual assistants?",
      answer: "Our VAs undergo rigorous screening including skills assessment, background checks, and specialized training. We match VAs based on expertise, industry experience, and your specific requirements."
    },
    {
      question: "What hours and time zones do your VAs work in?",
      answer: "We have VAs available across multiple time zones to match your business hours. Whether you need support during US business hours, European hours, or 24/7 coverage, we can accommodate your needs."
    },
    {
      question: "How do you handle communication and collaboration?",
      answer: "We use your preferred communication tools (Slack, Teams, email) and project management platforms. Regular check-ins, progress reports, and transparent communication ensure seamless collaboration."
    },
    {
      question: "Can I have the same VA consistently or will it change?",
      answer: "We assign dedicated VAs for consistency and relationship building. Backup coverage is available during vacations or sick days to ensure uninterrupted support."
    },
    {
      question: "What if I'm not satisfied with my assigned VA?",
      answer: "We provide a replacement guarantee. If you're not completely satisfied, we'll assign a different VA that better matches your needs at no additional cost."
    }
  ]

  const stats = [
    { label: "Tasks Completed", value: "15,000+", icon: Target, color: "from-primary-500 to-orange-500" },
    { label: "Client Satisfaction", value: "98%", icon: Star, color: "from-purple-500 to-violet-500" },
    { label: "Hours Saved", value: "8,000+", icon: Clock, color: "from-blue-500 to-cyan-500" },
    { label: "Active Clients", value: "26+", icon: Users, color: "from-green-500 to-emerald-500" }
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center bg-primary-500/10 rounded-full px-4 py-2 mb-6 border border-primary-500/20">
                <UserCheck className="w-4 h-4 text-primary-400 mr-2" />
                <span className="text-primary-400 text-sm font-semibold">VIRTUAL ASSISTANT EXCELLENCE</span>
              </div>
              
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight">
                Professional Virtual Assistant Support
              </h1>
              
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Dedicated virtual assistant support to handle administrative tasks, projects, and business operations while you focus on growth and strategy.
              </p>
              ...
              <div className="flex items-center gap-6 text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">26+ Happy Clients</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-300">All your VA needs handled</p>
                </div>
                
                <div className="space-y-4 mb-8">
                  {['Task Management', 'Document Preparation', 'Research Activities', 'Administrative Coordination', 'Process Optimization'].map((item, index) => (
                ...
                <div className="bg-white/5 rounded-lg p-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white mb-1">Starting at $10/hour</div>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-[1344px] mx-auto container-padding relative">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From initial consultation to ongoing support, we follow a systematic approach to deliver exceptional virtual assistant services.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-primary-50 to-orange-50 rounded-3xl p-8 border border-primary-200">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Our team can assign a dedicated virtual assistant within 48 hours. Let's discuss your needs and create a custom solution.
              </p>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-[1344px] mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Real results from businesses that have transformed their operations with our virtual assistant support.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Ready to Get Professional VA Support?
            </h2>
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Join successful businesses that have transformed their operations with TasksACE virtual assistant experts.
            </p>
