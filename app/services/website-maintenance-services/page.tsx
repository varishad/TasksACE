...
import { ArrowRight, CheckCircle, Star, Clock, Zap, ThumbsUp, ShieldCheck, ChevronDown, ChevronUp, Settings, RefreshCw, MessageSquare, Monitor, TrendingUp, Globe, DollarSign, Users } from 'lucide-react';
...
export default function WebsiteMaintenancePage() {
  ...
  const maintenanceServices = [
    {
      ...
      description: "Regular security monitoring, software updates, and vulnerability patches to keep your website safe and secure.",
      icon: ShieldCheck,
      features: ["Security Monitoring", "Software Updates", "Vulnerability Patches", "Malware Scanning"],
      deliverables: ["Security reports", "Update logs", "Patch management", "Threat monitoring"]
    },
    {
      title: "Performance Optimization",
      description: "Ongoing performance monitoring, speed optimization, and technical improvements to ensure fast loading times.",
      icon: Zap,
      features: ["Speed Optimization", "Performance Monitoring", "Database Cleanup", "Cache Management"],
      deliverables: ["Performance reports", "Speed improvements", "Optimization logs", "Cache setup"]
    },
    {
      title: "Content & Backup Management",
      description: "Regular content updates, backup management, and data protection to safeguard your website and information.",
      icon: RefreshCw,
      features: ["Content Updates", "Regular Backups", "Data Protection", "Recovery Planning"],
      deliverables: ["Backup schedules", "Content updates", "Recovery procedures", "Data security"]
    },
    {
      title: "Technical Support & Monitoring",
      description: "24/7 website monitoring, technical support, and issue resolution to ensure optimal website performance.",
      icon: Settings,
      features: ["24/7 Monitoring", "Technical Support", "Issue Resolution", "Uptime Tracking"],
      deliverables: ["Monitoring reports", "Support tickets", "Issue logs", "Uptime statistics"]
    }
  ]
  ...
  const pricingPlans = [
    {
      ...
      minHours: "Ongoing monthly service"
    },
    {
  ...
  const processSteps = [
    {
      ...
      description: "Comprehensive audit of your website's current state, security, performance, and maintenance needs.",
      duration: "Day 1",
      icon: MessageSquare
    },
    {
      ...
      description: "Configure monitoring tools, backup systems, and establish maintenance protocols for your website.",
      duration: "Day 2-3",
      icon: Monitor
    },
    {
      ...
      description: "Regular updates, monitoring, backups, and optimizations according to your selected maintenance plan.",
      duration: "Ongoing",
      icon: RefreshCw
    },
    {
      ...
      description: "Regular reports on website health, performance metrics, and responsive support for any issues.",
      duration: "Monthly",
      icon: TrendingUp
    }
  ]
  ...
  const benefits = [
    {
      ...
      description: "Protect your website from threats with regular security updates and monitoring",
      metric: "99.9% Security Rate",
      color: "from-emerald-500 to-green-500"
    },
    {
      icon: Zap,
      title: "Better Performance",
      description: "Maintain fast loading speeds and optimal performance with regular optimization",
      metric: "50% Faster Loading",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: Globe,
      title: "Higher Uptime",
      description: "Ensure your website stays online with proactive monitoring and quick issue resolution",
      metric: "99.9% Uptime",
    ...
    },
    {
      icon: DollarSign,
      title: "Cost Savings",
      description: "Prevent expensive emergency fixes with regular maintenance and proactive care",
  ...
  const testimonials = [
    {
      text: "TasksACE's website maintenance has been a game-changer! Our site runs perfectly, loads fast, and we haven't had any security issues. Peace of mind is priceless!",
      author: "Rachel Johnson",
      company: "Digital Marketing Agency",
      role: "CEO",
      rating: 5,
      savings: "Zero security issues",
      timeframe: "12 months"
    },
    {
      text: "Professional care package is worth every penny. Our website performance improved dramatically and the monthly reports keep us informed about everything.",
    ...
    {
      text: "The 24/7 monitoring caught issues before our customers even noticed. Response time is incredible and the team is always available when we need them.",
      author: "Sarah Wilson",
      company: "SaaS Company",
      role: "CTO",
      rating: 5,
      savings: "Proactive issue resolution",
      timeframe: "6 months"
    },
    {
      text: "Enterprise care with dedicated manager has been exceptional. Custom SLA and priority support ensure our mission-critical website never goes down.",
      author: "David Chen",
    ...
    {
      text: "The backup system saved us when we accidentally deleted important content. Recovery was instant and seamless. Excellent service!",
      author: "Jennifer Martinez",
      company: "Non-profit Organization",
      role: "Executive Director",
      rating: 5,
      savings: "Data recovery success",
      timeframe: "4 months"
    },
    {
      text: "Monthly maintenance reports are detailed and easy to understand. We know exactly what's being done and how our website is performing.",
      author: "Robert Kim",
      company: "Healthcare Practice",
      role: "Practice Manager",
      rating: 5,
      savings: "Transparent reporting",
      timeframe: "10 months"
    }
  ]
  ...
  const faqs = [
    {
      ...
      answer: "Our maintenance includes security updates, performance optimization, regular backups, uptime monitoring, content updates, technical support, and detailed reporting. The specific services depend on your chosen plan."
    },
    {
      question: "How often do you perform maintenance tasks?",
      answer: "Frequency varies by plan: Basic includes monthly updates and weekly backups, Professional has bi-weekly updates and daily backups, Enterprise features weekly updates and hourly backups."
    },
    {
      question: "What happens if my website goes down?",
      answer: "We monitor your site 24/7 and receive instant alerts if issues occur. Our team investigates immediately and works to restore your site quickly. Enterprise plans include emergency response guarantees."
    },
    {
      question: "Can you maintain websites built by other developers?",
      answer: "Yes! We can maintain websites built on any platform including WordPress, Shopify, custom builds, and more. We'll assess your site and create a tailored maintenance plan."
    },
    {
      question: "Do you provide reports on maintenance activities?",
      answer: "Absolutely! All plans include regular reports detailing completed tasks, website performance metrics, security status, and recommendations for improvements."
    }
  ]

  const stats = [
    { label: "Websites Maintained", value: "1,200+", icon: Globe, color: "from-primary-500 to-orange-500" },
    { label: "Happy Clients", value: "900+", icon: Users, color: "from-blue-500 to-cyan-500" },
    { label: "Average Uptime", value: "99.9%", icon: TrendingUp, color: "from-green-500 to-emerald-500" },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center bg-primary-500/10 rounded-full px-4 py-2 mb-6 border border-primary-500/20">
                ...
                <span className="text-primary-400 text-sm font-semibold">MAINTENANCE SPECIALISTS</span>
              </div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Keep your website secure, fast, and up-to-date with professional maintenance services. Proactive care that prevents problems and ensures optimal performance.
              </p>
              ...
              <div className="flex items-center gap-6 text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">1,200+ Sites Protected</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">Website Maintenance</h3>
                  <p className="text-gray-300">Ongoing care & protection</p>
                </div>
                
                <div className="space-y-4 mb-8">
                  {['Security Updates', '24/7 Monitoring', 'Regular Backups', 'Performance Optimization', 'Technical Support'].map((item, index) => (
                ...
                <div className="bg-white/5 rounded-lg p-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white mb-1">Starting at $99/month</div>
                    <div className="text-primary-400 text-sm">Basic maintenance plan</div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive website maintenance services designed to keep your site secure, fast, and performing optimally.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Proven advantages that protect your investment and ensure optimal website performance with our maintenance services.
            </p>
          </div>
      ...
      <section id="pricing" className="section-padding bg-white">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Transparent monthly pricing with no hidden fees. Choose the perfect plan for your website maintenance needs.
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto container-padding relative">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From initial setup to ongoing care, we follow a systematic approach to keep your website secure, fast, and optimally performing.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-primary-50 to-orange-50 rounded-3xl p-8 border border-primary-200">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Start comprehensive website maintenance today and ensure your site stays secure, fast, and optimally performing.
              </p>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Real results from businesses that have protected their websites with our professional maintenance services.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto container-padding">
          ...
          <div className="text-center mt-12">
            ...
            <Link href="/contact" className="inline-flex items-center text-orange-600 hover:text-orange-700 font-semibold transition-colors duration-300">
              Contact our maintenance specialists
              <ArrowRight className="w-4 h-4 ml-2" />
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            <div className="inline-flex items-center space-x-2 bg-primary-50 rounded-full px-4 py-2 mb-6 border border-primary-200">
              ...
              <span className="text-sm font-semibold text-primary-700">Ready to Protect?</span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Join hundreds of businesses that have protected their websites with TasksACE's professional maintenance services.
            </p>
