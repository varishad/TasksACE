...
export default function CustomerSupportPage() {
  ...
  const stats = [
    { label: "Support Tickets", value: "15,000+", icon: Headphones, color: "from-cyan-500 to-teal-500" },
    { label: "Happy Customers", value: "3,000+", icon: Users, color: "from-blue-500 to-blue-600" },
    { label: "Response Time", value: "<2 hours", icon: Clock, color: "from-purple-500 to-purple-600" },
    { label: "Satisfaction Rate", value: "98.5%", icon: ShieldCheck, color: "from-green-500 to-green-600" }
  ]

  const services = [
    {
      title: "Live Chat Support",
      description: "24/7 real-time customer assistance to resolve queries instantly and improve customer satisfaction.",
      icon: MessageSquare,
      features: ["24/7 Live Chat", "Multi-language Support", "Quick Response", "Screen Sharing"],
      deliverables: ["Chat transcripts", "Response analytics", "Customer feedback", "Resolution reports"]
    },
    {
      title: "Order Management",
      description: "Complete order lifecycle management from placement to delivery with proactive communication.",
      icon: Package,
      features: ["Order Tracking", "Status Updates", "Issue Resolution", "Proactive Communication"],
      deliverables: ["Order reports", "Status updates", "Issue logs", "Customer notifications"]
    },
    {
      title: "Email Support",
      description: "Professional email support with quick response times and comprehensive issue resolution.",
      icon: Mail,
      features: ["Professional Templates", "Quick Responses", "Issue Escalation", "Follow-up System"],
      deliverables: ["Email responses", "Resolution summaries", "Customer satisfaction surveys", "Response reports"]
    },
    {
      title: "Return & Refund Management",
      description: "Streamlined return and refund process management to ensure customer satisfaction and loyalty.",
      icon: RotateCcw,
      features: ["Return Processing", "Refund Management", "Quality Control", "Customer Retention"],
      deliverables: ["Return reports", "Refund processing", "Quality assessments", "Retention strategies"]
    }
  ]
  ...
  const benefits = [
    {
      icon: Clock,
      title: "Fast Response",
      description: "Average 2-hour response time with 24/7 availability for urgent customer issues",
      metric: "<2 Hour Response",
      color: "from-emerald-500 to-green-500"
    },
    {
      icon: Users,
      title: "Customer Retention",
      description: "Increase customer loyalty by 40% with professional, caring support experiences",
    ...
    },
    {
      ...
      description: "Achieve 98.5% customer satisfaction with expert support team handling",
      metric: "98.5% Satisfaction",
      color: "from-purple-500 to-violet-500"
    },
    {
      icon: ShieldCheck,
      title: "Professional Service",
      description: "Maintain consistent brand voice and professional communication standards",
  ...
  const processSteps = [
    {
      step: "01",
      title: "Support Setup",
      description: "We set up your customer support systems and integrate with your existing platforms.",
      duration: "1-2 days",
      icon: MessageSquare
    },
    {
      step: "02",
      title: "Team Training",
      description: "Our support team learns your products, policies, and brand voice for consistent service.",
      duration: "2-3 days",
      icon: Target
    },
    {
      step: "03",
      title: "Go Live",
      description: "Start handling customer inquiries with professional, timely, and effective support.",
      duration: "24 hours",
      icon: Zap
    },
    {
      ...
      description: "Continuous monitoring and optimization with detailed reporting and feedback analysis.",
      duration: "Ongoing",
      icon: BarChart3
    }
  ]
  ...
  const testimonials = [
    {
      text: "TasksACE customer support team is amazing! They handle our customers with such care and professionalism. Our satisfaction scores increased by 45%!",
      author: "Rachel Thompson",
      company: "Fashion Boutique Online",
      role: "Store Owner",
      rating: 5,
      savings: "45% Higher Satisfaction",
      timeframe: "3 months"
    },
    {
      text: "24/7 support coverage has been a game-changer for our international customers. Response times are incredibly fast and quality is consistently excellent.",
      author: "Alex Chen",
      company: "Global Electronics Store",
      role: "Customer Success Manager",
      rating: 5,
      savings: "24/7 Coverage",
      timeframe: "2 months"
    },
    {
      text: "The return and refund management is seamless! They handle everything professionally and keep our customers happy throughout the process.",
      author: "Maria Garcia",
      company: "Home Goods Plus",
      role: "Operations Director",
      rating: 5,
      savings: "Seamless Returns",
      timeframe: "4 months"
    },
    {
      text: "Professional live chat support has increased our conversion rates significantly. Customers get instant help and make purchases with confidence.",
      author: "David Kim",
      company: "Tech Gadgets Pro",
      role: "E-commerce Manager",
      rating: 5,
      savings: "Higher Conversions",
      timeframe: "6 weeks"
    },
    {
      text: "Order management support is exceptional! They track everything, communicate proactively, and resolve issues before customers even notice.",
      author: "Jennifer Martinez",
      company: "Sports Equipment Hub",
      role: "Customer Service Lead",
      rating: 5,
      savings: "Proactive Service",
      timeframe: "2 months"
    },
    {
      text: "The detailed reporting and analytics help us understand our customers better. Customer satisfaction improved from 85% to 98.5%!",
      author: "Robert Johnson",
      company: "Beauty Products Store",
      role: "CEO",
      rating: 5,
      savings: "98.5% Satisfaction",
      timeframe: "3 months"
    }
  ]
  ...
  const pricingPlans = [
    {
      name: "Starter",
      price: "$599/month",
      description: "Perfect for small stores with basic support needs",
      features: [
      ...
      minHours: "Basic customer support"
    },
    {
      name: "Professional",
      price: "$1,199/month",
      ...
      minHours: "Professional support features"
    },
    {
      name: "Enterprise",
      price: "$2,399/month",
      ...
      minHours: "Enterprise-level support"
    }
  ]

  const faqs = [
    {
      question: "What channels do you provide customer support through?",
      answer: "We provide support through live chat, email, and phone (for Enterprise plans). All channels are managed by professional support specialists trained in your products and policies."
    },
    {
      question: "How quickly do you respond to customer inquiries?",
      answer: "Response times vary by plan: Starter (8 hours), Professional (2 hours), Enterprise (30 minutes). We also provide 24/7 coverage for urgent issues on Professional and Enterprise plans."
    },
    {
      question: "Can you handle returns and refunds on our behalf?",
      answer: "Yes! We manage the complete return and refund process according to your policies. This includes processing requests, coordinating with logistics, and maintaining customer satisfaction throughout."
    },
    {
      question: "How do you maintain our brand voice in customer communications?",
      answer: "Our team undergoes comprehensive training on your brand voice, policies, and communication style. We use approved templates and escalation procedures to ensure consistent, on-brand customer interactions."
    },
    {
      question: "What reporting and analytics do you provide?",
      answer: "We provide detailed reports on response times, resolution rates, customer satisfaction scores, common issues, and team performance. Enterprise customers get real-time analytics dashboards."
    }
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center bg-primary-500/10 rounded-full px-4 py-2 mb-6 border border-primary-500/20">
                <Headphones className="w-4 h-4 text-primary-400 mr-2" />
                <span className="text-primary-400 text-sm font-semibold">CUSTOMER SUPPORT EXPERTS</span>
              </div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Deliver exceptional customer experiences with professional support team. 24/7 live chat, 
                email support, order management, and return processing to keep your customers happy.
              </p>
              ...
              <div className="flex items-center gap-6 text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">15,000+ Tickets</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">&lt;2 hours Response</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-300">All customer support needs handled</p>
                </div>
                
                <div className="space-y-4 mb-8">
                  {['Live Chat Support', 'Order Management', 'Email Support', 'Return & Refund Management', '24/7 Availability'].map((item, index) => (
                ...
                <div className="bg-white/5 rounded-lg p-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white mb-1">Starting at $599/month</div>
                    <div className="text-primary-400 text-sm">Up to 200 tickets/month</div>
                  </div>
                </div>
        ...
        <div className="max-w-[1344px] mx-auto container-padding">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive customer support solutions designed to deliver exceptional customer experiences and drive loyalty.
            </p>
          </div>
        ...
        <div className="max-w-[1344px] mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Measurable improvements to your customer satisfaction and business performance.
            </p>
          </div>
      ...
      <section id="pricing" className="section-padding bg-white">
        <div className="max-w-[1344px] mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Transparent pricing with no hidden fees. Choose the plan that fits your customer support needs.
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-[1344px] mx-auto container-padding relative">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From setup to ongoing support, we follow a systematic approach to deliver exceptional customer service experiences.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-primary-50 to-orange-50 rounded-3xl p-8 border border-primary-200">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Our team can set up your customer support system within 24 hours. Let's discuss your requirements and create exceptional experiences.
              </p>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-[1344px] mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Real results from businesses that have enhanced their customer experience with our support services.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              <span className="whitespace-nowrap">Ready to Enhance Your</span> Customer Support?
            </h2>
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Join 3,000+ happy customers who trust TasksACE for professional, caring customer support that builds loyalty.
            </p>
