...
import { ArrowRight, CheckCircle, Star, Clock, Zap, ThumbsUp, ShieldCheck, ChevronDown, ChevronUp, Share2, MessageSquare, Users, Target, BarChart3, Layout, Camera, TrendingUp, Heart, DollarSign, Globe } from 'lucide-react';
...
export default function SocialMediaManagementPage() {
  ...
  const socialMediaServices = [
    {
      ...
      description: "Daily engaging content creation and scheduled posting across all your social media platforms to maintain consistent presence.",
      icon: MessageSquare,
      features: ["Daily Content Creation", "Platform Optimization", "Hashtag Strategy", "Visual Design"],
      deliverables: ["Daily posts", "Branded graphics", "Content calendar", "Performance metrics"]
    },
    {
      title: "Community Management",
      description: "Active community engagement including responding to comments, messages, and building relationships with your audience.",
      icon: Users,
      features: ["Comment Management", "Direct Messages", "Community Building", "Customer Service"],
      deliverables: ["24/7 monitoring", "Response management", "Community growth", "Engagement reports"]
    },
    {
      title: "Social Media Strategy",
      description: "Comprehensive social media strategy development aligned with your business goals and target audience insights.",
      icon: Target,
      features: ["Strategy Development", "Audience Analysis", "Competitor Research", "Goal Setting"],
      deliverables: ["Strategic plan", "Content strategy", "Growth tactics", "KPI tracking"]
    },
    {
      title: "Analytics & Reporting",
      description: "Detailed performance tracking and monthly reports showing growth metrics, engagement rates, and ROI analysis.",
      icon: BarChart3,
      features: ["Performance Tracking", "Growth Analytics", "ROI Analysis", "Competitor Insights"],
      deliverables: ["Monthly reports", "Growth insights", "Performance data", "Strategic recommendations"]
    }
  ]
  ...
  const pricingPlans = [
    ...
    },
    {
      name: "Enterprise",
      price: "$2,299/month",
      description: "For serious social media growth",
      features: [
        "Unlimited Platforms",
  ...
  const processSteps = [
    {
      ...
      description: "Analyze your brand, audience, and competitors to develop a comprehensive social media strategy and optimize profiles.",
      duration: "Week 1",
      icon: Target
    },
    {
      ...
      description: "Create content calendars, develop brand voice guidelines, and plan engaging content themes and campaigns.",
      duration: "Week 2",
      icon: Layout
    },
    {
      ...
      description: "Design graphics, write engaging captions, create videos, and schedule posts across all platforms for maximum reach.",
      duration: "Ongoing",
      icon: Camera
    },
    {
      ...
      description: "Monitor engagement, respond to comments, analyze performance, and continuously optimize strategy for better results.",
      duration: "Daily",
      icon: TrendingUp
    }
  ]
  ...
  const benefits = [
    {
      ...
      description: "Strategic content and engagement tactics that attract and retain followers across all platforms",
    ...
    },
    {
      ...
      description: "Engaging content and active community management that drives likes, comments, and shares",
      metric: "350% More Engagement",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: DollarSign,
      title: "Increased Revenue",
      description: "Social media strategies that drive traffic, generate leads, and convert followers into customers",
    ...
    },
    {
      ...
      description: "Consistent posting and strategic campaigns that increase brand recognition and market presence",
      metric: "300% Brand Reach",
  ...
  const testimonials = [
    {
      text: "TasksACE transformed our social media presence completely. Our Instagram followers grew from 5K to 50K in just 8 months and we're getting daily inquiries from social media!",
      author: "Amanda Rodriguez",
      company: "Fashion Boutique",
      role: "Business Owner",
      rating: 5,
      savings: "1000% follower growth",
      timeframe: "8 months"
    },
    {
      text: "The professional package has been incredible. Our engagement rates increased by 400% and we're now generating significant revenue directly from our social media channels.",
      author: "Marcus Johnson",
      company: "Fitness Studio",
      role: "Marketing Manager",
      rating: 5,
      savings: "400% engagement boost",
      timeframe: "6 months"
    },
    {
      text: "Community management service has been a game-changer. Customer satisfaction improved dramatically and we're building real relationships with our audience every day.",
      author: "Sarah Chen",
      company: "Tech Startup",
      role: "Founder",
      rating: 5,
      savings: "Better customer relations",
      timeframe: "12 months"
    },
    {
      text: "The content quality and consistency is outstanding. Our brand now has a professional presence across all platforms and our competitors can't keep up.",
    ...
    {
      text: "Enterprise package with dedicated team provides everything we need. Our social media ROI has increased by 300% and we're industry leaders in our space.",
      author: "Jennifer Kim",
    ...
    {
      text: "The analytics and reporting help us understand exactly what's working. We've optimized our entire marketing strategy based on social media insights.",
      author: "Robert Davis",
  ...
  const faqs = [
    {
      ...
      answer: "We manage all major platforms including Facebook, Instagram, Twitter, LinkedIn, TikTok, YouTube, Pinterest, and any other platforms relevant to your business and audience."
    },
    {
      question: "How often do you post on social media?",
      answer: "Posting frequency depends on your package and platform. Basic package includes 15 posts per month across 3 platforms, Professional includes 30 posts across 5 platforms, and Enterprise includes daily content creation."
    },
    {
      question: "Do you create original graphics and videos?",
      answer: "Yes! We create custom graphics, videos, and visual content aligned with your brand. Professional and Enterprise packages include advanced video production and motion graphics."
    },
    {
      question: "How do you handle negative comments or reviews?",
      answer: "We monitor all platforms 24/7 and respond professionally to all comments and messages. We have established protocols for handling negative feedback and turning it into positive customer experiences."
    },
    {
      question: "What kind of results can I expect and when?",
      answer: "Most clients see initial engagement improvements within 2-4 weeks. Significant follower growth typically occurs within 2-3 months, and substantial business impact usually happens within 4-6 months of consistent management."
    }
  ]

  const stats = [
    { label: "Accounts Managed", value: "1,200+", icon: Users, color: "from-primary-500 to-orange-500" },
    { label: "Posts Created", value: "50,000+", icon: MessageSquare, color: "from-blue-500 to-cyan-500" },
    { label: "Avg Follower Growth", value: "+380%", icon: TrendingUp, color: "from-green-500 to-emerald-500" },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Grow your social media presence with expert management. From content creation to community engagement, we help brands build meaningful connections and drive results.
              </p>
              ...
              <div className="flex items-center gap-6 text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">1,200+ Accounts</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-yellow-500" />
                  <span className="text-sm">+380% Growth</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">Complete Social Media Management</h3>
                  <p className="text-gray-300">All platforms managed</p>
                </div>
                
                <div className="space-y-4 mb-8">
                  {['Content Creation', 'Community Management', 'Social Strategy', 'Analytics & Reporting', 'Growth Optimization'].map((item, index) => (
                ...
                <div className="bg-white/5 rounded-lg p-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white mb-1">Starting at $499/month</div>
                    <div className="text-primary-400 text-sm">3 platforms + 15 posts</div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive social media management services designed to grow your following and drive business results.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Measurable improvements to your social media performance and business growth.
            </p>
          </div>
      ...
      <section id="pricing" className="section-padding bg-white">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Transparent pricing with no hidden fees. Choose the perfect plan for your social media growth goals.
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto container-padding relative">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From strategy to execution, we follow a proven process to grow your social media presence and drive business results.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-primary-50 to-orange-50 rounded-3xl p-8 border border-primary-200">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Start growing your social media presence today with our expert management services and proven growth strategies.
              </p>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Real results from businesses that have grown their social media presence with our management services.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Join hundreds of businesses that have grown their social media presence with TasksACE's expert management services.
            </p>
