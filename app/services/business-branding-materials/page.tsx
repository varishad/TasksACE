...
import { ArrowRight, CheckCircle, Star, Clock, Briefcase, Zap, ThumbsUp, ShieldCheck, ChevronDown, ChevronUp, CreditCard, Presentation, FileText, Target, MessageSquare, BarChart3, DollarSign, TrendingUp } from 'lucide-react';
import Link from 'next/link'

export default function BusinessMaterialsDesignPage() {
  ...
  const businessMaterialsServices = [
    {
      title: "Business Cards",
      description: "Professional business card designs that make lasting first impressions and represent your brand perfectly.",
      icon: CreditCard,
      features: ["Professional Design", "Multiple Layouts", "Print-Ready Files", "Brand Consistency"],
      deliverables: ["High-resolution files", "Print specifications", "Digital versions", "Brand guidelines"]
    },
    {
      title: "Presentation Design",
      description: "Compelling presentation designs for pitches, meetings, and conferences that engage your audience.",
      icon: Presentation,
      features: ["Slide Layouts", "Data Visualization", "Brand Integration", "Template Creation"],
      deliverables: ["PowerPoint templates", "Slide masters", "Icon library", "Brand assets"]
    },
    {
      title: "Brochures",
      description: "Eye-catching brochures that effectively communicate your services and capture customer interest.",
      icon: FileText,
      features: ["Tri-fold Design", "Bi-fold Options", "Product Catalogs", "Service Overviews"],
      deliverables: ["Print-ready brochures", "Digital versions", "Editable templates", "Brand compliance"]
    },
    {
      title: "Marketing Materials",
      description: "Complete suite of marketing materials including flyers, posters, and promotional content.",
      icon: Target,
      features: ["Event Materials", "Promotional Flyers", "Product Sheets", "Sales Collateral"],
      deliverables: ["Multi-format files", "Campaign materials", "Brand templates", "Usage guidelines"]
    }
  ]
  ...
  const pricingPlans = [
    {
      name: "Starter",
      price: "$25/item",
      description: "Perfect for small business material needs",
      features: [
        "1 Design Concept",
        "3 Revisions",
        "48-72 Hour Delivery",
    ...
    },
    {
      name: "Enterprise",
      price: "$299/month",
      description: "For ongoing business material needs",
      features: [
        "15 Items per Month",
        "Unlimited Revisions",
        "Same Day Delivery",
  ...
  const processSteps = [
    {
      ...
      description: "Understand your business needs, brand guidelines, and material specifications.",
      duration: "Same day",
      icon: MessageSquare
    },
    {
      ...
      description: "Create professional business materials that align with your brand identity and objectives.",
      duration: "1-2 days",
      icon: Target
    },
    {
      ...
      description: "Review designs and implement feedback to ensure perfect alignment with your vision.",
    ...
    },
    {
      ...
      description: "Deliver print-ready and digital files with complete specifications and brand guidelines.",
      duration: "Same day",
      icon: BarChart3
    }
  ]
  ...
  const benefits = [
    {
      ...
      description: "Save up to 75% compared to traditional design agencies and freelancers",
      metric: "75% Cost Savings",
      color: "from-emerald-500 to-green-500"
    },
    {
      icon: Clock,
      title: "Fast Turnaround",
      description: "Quick delivery with most business materials completed within 24-48 hours",
      metric: "24-48 Hours",
    ...
    },
    {
      ...
      description: "High-quality materials that enhance your business credibility and brand perception",
    ...
    },
    {
      ...
      description: "Consistent visual identity across all your business materials and touchpoints",
  ...
  const testimonials = [
    {
      text: "TasksACE transformed our business materials completely. Our new business cards and brochures look incredibly professional and have significantly improved our client perception!",
      author: "Robert Chen",
      company: "Consulting Solutions Inc.",
      role: "Managing Director",
      rating: 5,
      savings: "Professional credibility",
      timeframe: "2 weeks"
    },
    {
      text: "The presentation design service is outstanding. Our investor pitches now look polished and professional, helping us secure funding more effectively.",
      author: "Maria Rodriguez",
      company: "Tech Startup Hub",
      role: "CEO",
      rating: 5,
      savings: "Secured funding",
      timeframe: "1 month"
    },
    {
      text: "Business card designs exceeded expectations. Multiple concepts, perfect execution, and print coordination made the entire process seamless.",
    ...
    {
      text: "Marketing materials designed by TasksACE helped us win three major contracts. The professional quality speaks volumes about our business.",
      author: "Sophie Anderson",
      company: "Engineering Solutions",
      role: "Business Development",
      rating: 5,
      savings: "Won 3 major contracts",
      timeframe: "2 months"
    },
    {
      text: "The enterprise package with dedicated designer ensures all our materials maintain perfect brand consistency across every touchpoint.",
    ...
    {
      text: "Brochure designs have dramatically improved our lead generation. Professional materials that convert prospects into customers effectively.",
      author: "Jennifer Williams",
      company: "Real Estate Group",
      role: "Sales Manager",
      rating: 5,
      savings: "Better lead generation",
      timeframe: "4 months"
    }
  ]
  ...
  const faqs = [
    {
      question: "What types of business materials can you design?",
      answer: "We design business cards, presentations, brochures, flyers, letterheads, invoices, proposals, marketing materials, and any other business collateral you need to represent your brand professionally."
    },
    {
      question: "Do you handle print coordination and specifications?",
      answer: "Yes! We provide print-ready files with complete specifications, recommend trusted print vendors, and can coordinate the entire printing process to ensure perfect results."
    },
    {
      question: "Can you work with our existing brand guidelines?",
      answer: "Absolutely! We can incorporate your existing brand colors, fonts, logos, and style guidelines. If you don't have guidelines, we can create them as part of your project."
    },
    {
      question: "What file formats will we receive?",
      answer: "You'll receive high-resolution print files (PDF, AI, EPS), web-optimized versions (JPG, PNG), and editable source files. Professional packages include additional formats and templates."
    },
    {
      question: "How do you ensure brand consistency across materials?",
      answer: "We create comprehensive brand guidelines and templates that ensure consistent use of colors, fonts, layouts, and imagery across all your business materials and future projects."
    }
  ]

  const stats = [
    { label: "Materials Designed", value: "3,000+", icon: FileText, color: "from-primary-500 to-orange-500" },
    { label: "Businesses Served", value: "400+", icon: Briefcase, color: "from-blue-500 to-cyan-500" },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center bg-primary-500/10 rounded-full px-4 py-2 mb-6 border border-primary-500/20">
                ...
                <span className="text-primary-400 text-sm font-semibold">BUSINESS DESIGN EXPERTS</span>
              </div>
              
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight">
                Professional Business Materials Design
              </h1>
              
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Professional business cards, presentations, brochures, and marketing materials that elevate your brand and make lasting impressions.
              </p>
              ...
              <div className="flex items-center gap-6 text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">3,000+ Materials Designed</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">Complete Business Suite</h3>
                  <p className="text-gray-300">All business materials designed</p>
                </div>
                
                <div className="space-y-4 mb-8">
                  {['Business Cards', 'Presentation Design', 'Brochures', 'Marketing Materials', 'Brand Guidelines'].map((item, index) => (
                ...
                <div className="bg-white/5 rounded-lg p-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white mb-1">Starting at $25/item</div>
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive business materials design services to enhance your professional image and brand credibility.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {businessMaterialsServices.map((service, index) => {
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Measurable improvements to your business credibility and professional image.
            </p>
          </div>
      ...
      <section id="pricing" className="section-padding bg-white">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Transparent pricing with no hidden fees. Choose the perfect plan for your business material needs.
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto container-padding relative">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From concept to print-ready files, we follow a systematic approach to deliver exceptional business materials.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-primary-50 to-orange-50 rounded-3xl p-8 border border-primary-200">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Our design team can start creating professional business materials for your brand within hours. Let's discuss your needs and enhance your business image.
              </p>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Real results from businesses that have enhanced their professional image with our design services.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Ready to Elevate Your Business Materials?
            </h2>
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Join hundreds of businesses that have enhanced their professional image with TasksACE's business materials design services.
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <div className="flex flex-wrap justify-center items-center gap-8 text-gray-600">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm">Print-Ready Files</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 text-primary-500" />
                  <span className="text-sm">Professional Quality</span>
