          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <Image src="/tasksace-logo.png" alt="TasksACE Logo" width={40} height={40} className="w-10 h-10 object-contain rounded-lg shadow-medium" />
                <div className="text-xl text-white font-inter">
                  <span className="font-bold">Tasks</span><span style={{ color: '#ff5e00' }} className="font-normal">ACE</span>
                </div>
              </div>
