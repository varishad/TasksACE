...
import { trackEvent, analyticsEvents } from '@/lib/config';
...
export default function WhatsAppFloat() {
  ...
  const handleWhatsAppClick = () => {
    ...
    if (typeof window !== 'undefined') {
      window.open('https://wa.me/8801981696760', '_blank', 'noopener,noreferrer');
    }
  };
  ...
  return (
    ...
    >
      <button
        ...
        className="group relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-green-200"
      ...
      >
        ...
        <div className="absolute right-full mr-3 top-1/2 transform -translate-y-1/2 bg-gray-900 text-white text-sm px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
          <span>WhatsApp for fast reply!</span>
